...
public class Jun_BezierCurveEditor : Editor 
{
    ...
    public static void DrawCurve (Jun_BezierCurve tar)
    {
        for (int i = 0; i < tar.pointCount; i++)
        {
            ...
            var fmh_56_85_638872345532586518 = Quaternion.identity; Vector3 pointPos = Handles.FreeMoveHandle(thisPoint.transform.position, handleSize, Vector3.zero, Handles.SphereHandleCap);
			...
			{            
				...
				{
					var fmh_67_77_638872345532599235 = Quaternion.identity; Vector3 handle01Pos = Handles.FreeMoveHandle(thisPoint.worldHandles01, handleSize, Vector3.zero, Handles.CubeHandleCap);
					...
					var fmh_75_77_638872345532602746 = Quaternion.identity; Vector3 handle02Pos = Handles.FreeMoveHandle(thisPoint.worldHandles02, handleSize, Vector3.zero, Handles.CubeHandleCap);
